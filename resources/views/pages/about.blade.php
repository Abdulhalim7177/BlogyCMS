...
<div class="section sec-halfs py-0">
    <div class="container">
        <div class="half-content d-lg-flex align-items-stretch">
            <div class="img" style="background-image: url('assets/images/hero_1.jpg')" data-aos="fade-in" data-aos-delay="100">
        ...
        <div class="half-content d-lg-flex align-items-stretch">
            <div class="img order-md-2" style="background-image: url('assets/images/hero_2.jpg')" data-aos="fade-in">
...
<div class="section">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4 text-center" data-aos="fade-up" data-aos-delay="0">
                <img src="images/" alt="Image" class="img-fluid w-50 rounded-circle mb-3">
